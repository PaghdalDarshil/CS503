...
/*Function prototypes are provided to define the functions for later use and improve code organization.*/
void  usage(char *);
int   count_words(char *);
void  reverse_string(char *);
void  word_print(char *);

// This function displayes the usage of the program
...
int count_words(char *str) {
    ...
    // Please implement
    //This is used to iterate over each charecters in the string.
    for (int i = 0; i < len; i++) {
        if (!word_start) {
            if (str[i] != SPACE_CHAR) {
                wc++;
...
void  reverse_string(char *str) {
    ...
    // Please implement
    // this is swaping the characters until the middle of the string is reached.
...
void  word_print(char *str)
{
    ...
    // Please implement
    // this iterate over each character in the string.
    for(int i=0; i<len;i++)
    {
        if(!word_start)
        {
...
int main(int argc, char *argv[])
{
    ...
    switch (opt){
        ...
        //     /* This function counts words by recognizing transitions between space and non-space characters. */

        int wc = count_words(input_string); // Properly scoped variable
        printf("Word Count: %d\n", wc);
        break;
    }
        case 'r':
            ...
            /* This function modifies the original string in place by swapping characters from both ends. */
            ...
            /*The string is represented as an array of characters in C, and modifying its elements 
            directly changes the original string.The reversal swaps characters at opposite ends of the string until
            the indices meet in the middle. No new memory is allocated, and the changes are reflected in the same
            array.*/
            break;
        case 'w':
            printf("Word Print\n----------\n");
            ...
            /* This function identifies words, prints them with indices and lengths, and handles spaces appropriately. */
            word_print(input_string);
            break;

        //TODO: #6. What is the purpose of the default option here?
        /* This option handles invalid inputs by showing the usage and exiting, ensuring input validation.
        If the user provides an option other than -h, -c, -r, or -w, the program prints usage instructions
    ...
    /* Break statements in case prevent fall-through to other cases. Without them, unintended behavior would occur. */
    return 0;
}